...
<div class="max-w-4xl mx-auto w-full overflow-x-hidden">
    ...
    <div class="bg-gradient-to-r from-blue-900 via-indigo-900 to-slate-900 text-white rounded-2xl p-5 sm:p-8 shadow-xl mb-6 sm:mb-8 border border-indigo-700/40 relative overflow-hidden">
        <div class="relative z-10">
            ...
            <h1 class="text-xl sm:text-3xl font-bold tracking-tight text-white mb-2 leading-tight">Formulir Pengajuan Cuti Pegawai</h1>
                ...
                <div class="border-b border-slate-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <span class="text-[10px] sm:text-[11px] text-slate-500 mt-1 block">Tentukan 1 tanggal spesifik untuk hari cuti ini</span>
                        ...
                        <div class="w-full">
                            ...
                            <select name="jenis_cuti" id="jenis_cuti" class="w-full max-w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2.5 sm:p-3 bg-slate-50 border text-slate-900 text-xs sm:text-sm font-medium" required>
                        ...
                        <div class="md:col-span-2 bg-blue-50 border border-blue-200 rounded-xl p-3.5 flex items-start sm:items-center gap-3 text-xs text-blue-900">
                            ...
                            <div class="leading-relaxed text-[11px] sm:text-xs">
                                <strong>Ketentuan 1 Hari Cuti:</strong> Setiap pengajuan memotong 1 hari kuota cuti. Jika mengajukan cuti 3 hari berturut-turut, silakan kirimkan formulir ini 3 kali sesuai tanggal yang diinginkan.
                            </div>
                        </div>
